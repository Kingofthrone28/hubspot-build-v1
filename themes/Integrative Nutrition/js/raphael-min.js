...
function(a, b) {
    ...
    function s(a, d, e, f, g, h) {
        ...
        if (i) {
            if (j)
                ...
                for (var y in i)
                    if (i[z](y) && (da[z](y) || d.paper.customAttributes[z](y)))
                        switch (r[y] = d.attr(y),
                        null == r[y] && (r[y] = ca[y]),
                        s[y] = i[y],
                        da[y]) {
    ...
    /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\))\s*$/i), Y = {
        ...
        Infinity: 1,
        "-Infinity": 1
    }, Z = /^(?:cubic-)?bezier\(([^,]+),([^,]+),([^,]+),([^\)]+)\)/, $ = N.round, _ = parseFloat, aa = parseInt, ba = I.prototype.toUpperCase, ca = c._availableAttrs = {
        "arrow-end": "none",
        "arrow-start": "none",
        blur: 0,
        ...
        x: T,
        y: T
    }, ea = /[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*/, fa = {
        hs: 1,
        rg: 1
    ...
    c.getRGB = f(function(a) {
        ...
        !(fa[z](a.toLowerCase().substring(0, 2)) || "#" == a.charAt()) && (a = ta(a));
        var b, d, e, f, h, i, j = a.match(X);
        return j ? (j[2] && (e = aa(j[2].substring(5), 16),
        d = aa(j[2].substring(3, 5), 16),
        b = aa(j[2].substring(1, 3), 16)),
        j[3] && (e = aa((h = j[3].charAt(3)) + h, 16),
        d = aa((h = j[3].charAt(2)) + h, 16),
        b = aa((h = j[3].charAt(1)) + h, 16)),
        j[4] && (i = j[4][J](ea),
        b = _(i[0]),
        "%" == i[0].slice(-1) && (b *= 2.55),
        d = _(i[1]),
        ...
        i[3] && "%" == i[3].slice(-1) && (f /= 100),
        c.hsb2rgb(b, d, e, f)) : j[6] ? (i = j[6][J](ea),
        b = _(i[0]),
        "%" == i[0].slice(-1) && (b *= 2.55),
        d = _(i[1]),
        "%" == i[1].slice(-1) && (d *= 2.55),
    ...
    c.parsePathString = function(a) {
        ...
        var d = {
          ...
          , e = [];
        return c.is(a, V) && c.is(a[0], V) && (e = Ba(a)),
        e.length || I(a).replace(ha, function(a, b, c) {
            var f = []
              , g = b.toLowerCase();
    ...
    c.parseTransformString = f(function(a) {
        if (!a)
            return null;
        var b = [];
        return c.is(a, V) && c.is(a[0], V) && (b = Ba(a)),
        b.length || I(a).replace(ia, function(a, c, d) {
            {
                var e = [];
                M.call(c)
            }
            d.replace(ja, function(a, b) {
                b && e.push(+b)
            }),
            b.push([c][E](e))
        }),
    ...
    var Aa = c.pathBBox = function(a) {
      ...
      , Ia = f(function(a, b, c, d, e, f, g, h) {
        ...
        return Q(m) > "1e12" && (m = .5),
        Q(n) > "1e12" && (n = .5),
        m > 0 && 1 > m && (i = Ha(a, b, c, d, e, f, g, h, m),
        p.push(i.x),
        o.push(i.y)),
        n > 0 && 1 > n && (i = Ha(a, b, c, d, e, f, g, h, n),
        p.push(i.x),
        o.push(i.y)),
        j = f - 2 * d + b - (h - 2 * f + d),
        k = 2 * (d - b) - 2 * (f - d),
    ...
    for (var Pa = function() {
        ...
        return A.doc.addEventListener ? function(a, b, c, d) {
            ...
            F && L[b]) {
                var f = function(b) {
                    for (var e = Ta(b), f = b, g = 0, h = b.targetTouches && b.targetTouches.length; h > g; g++)
                        if (b.targetTouches[g].target == a) {
                            b = b.targetTouches[g],
                            b.originalEvent = f,
                            b.preventDefault = Qa,
                            b.stopPropagation = Sa;
                            break
                        }
        ...
        : A.doc.attachEvent ? function(a, b, c, d) {
            var e = function(a) {
                ...
                var b = A.doc.documentElement.scrollTop || A.doc.body.scrollTop
                  ...
                  , f = a.clientX + e
                  , g = a.clientY + b;
                return a.preventDefault = a.preventDefault || Pa,
                a.stopPropagation = a.stopPropagation || Ra,
                c.call(d, a, f, g)
            };
        ...
        for (var c, d = a.clientX, e = a.clientY, f = A.doc.documentElement.scrollTop || A.doc.body.scrollTop, g = A.doc.documentElement.scrollLeft || A.doc.body.scrollLeft, h = Va.length; h--; ) {
            if (c = Va[h],
            F && a.touches) {
        ...
        c.unmousemove(Wa).unmouseup(Xa);
        for (var d, e = Va.length; e--; )
            d = Va[e],
            d.el._drag = {},
            b("raphael.drag.end." + d.el.id, d.end_scope || d.start_scope || d.move_scope || d.el, a);
        Va = []
    }, Ya = c.el = {}, Za = K.length; Za--; )
        !function(a) {
            c[a] = Ya[a] = function(b, d) {
                return c.is(b, "function") && (this.events = this.events || [],
                this.events.push({
                    name: a,
                    f: b,
                    unbind: Ua(this.shape || this.node || A.doc, a, b, d || this)
                })),
                this
            }
            ,
            c["un" + a] = Ya["un" + a] = function(b) {
    ...
    ,
    Ya.removeData = function(a) {
        return null == a ? ka[this.id] = {} : ka[this.id] && delete ka[this.id][a],
        this
    }
    ,
    Ya.getData = function() {
    ...
    ,
    Ya.hover = function(a, b, c, d) {
        return this.mouseover(a, c).mouseout(b, d || c)
    }
    ,
    Ya.unhover = function(a, b) {
        return this.unmouseover(a).unmouseout(b)
    }
    ;
    var $a = [];
    Ya.drag = function(a, d, e, f, g, h) {
        function i(i) {
            ...
            this._drag.x = j + m,
            this._drag.y = k + l,
            !Va.length && c.mousemove(Wa).mouseup(Xa),
            Va.push({
                el: this,
                move_scope: f,
                start_scope: g,
    ...
    ,
    Ya.getBBox = function(a) {
        if (this.removed)
            return {};
        var b = this._;
        return a ? ((b.dirty || !b.bboxwt) && (this.realPath = pa[this.type](this),
    ...
    ;
    var ab = function(a, b, d, e, f, g, h, i, l) {
        ...
        return function(d, e, f) {
            ...
            for (var g, h, i, j, k, l = "", m = {}, n = 0, o = 0, p = d.length; p > o; o++) {
                ...
                "M" == i[0])
                    ...
                    if (j = ab(g, h, i[1], i[2], i[3], i[4], i[5], i[6]),
                    n + j > e) {
                        if (b && !m.start) {
                            if (k = ab(g, h, i[1], i[2], i[3], i[4], i[5], i[6], e - n),
                        ...
                        if (!a && !b)
                            return k = ab(g, h, i[1], i[2], i[3], i[4], i[5], i[6], e - n),
                            {
                                x: k.x,
                                y: k.y,
                                alpha: k.alpha
    ...
    c.getSubpath = function(a, b, c) {
        if (this.getTotalLength(a) - c < 1e-6)
            return eb(a, b).end;
        var d = eb(a, c, 1);
        return b ? eb(d, b).end : d
    }
    ,
    Ya.getTotalLength = function() {
        var a = this.getPath();
        if (a)
            return this.node.getTotalLength ? this.node.getTotalLength() : cb(a)
    }
    ,
    Ya.getPointAtLength = function(a) {
        var b = this.getPath();
        if (b)
            return db(b, a)
    }
    ...
    ,
    Ya.getSubpath = function(a, b) {
        var d = this.getPath();
        if (d)
            return c.getSubpath(d, a, b)
    }
    ;
    var fb = c.easing_formulas = {
        linear: function(a) {
            return a
        },
        "<": function(a) {
    ...
    fb.easeIn = fb["ease-in"] = fb["<"],
    fb.easeOut = fb["ease-out"] = fb[">"],
    fb.easeInOut = fb["ease-in-out"] = fb["<>"],
    fb["back-in"] = fb.backIn,
    fb["back-out"] = fb.backOut;
    var gb = []
      , hb = a.requestAnimationFrame || a.webkitRequestAnimationFrame || a.mozRequestAnimationFrame || a.oRequestAnimationFrame || a.msRequestAnimationFrame || function(a) {
        setTimeout(a, 16)
    }
      , ib = function() {
        for (var a = +new Date, d = 0; d < gb.length; d++) {
            var e = gb[d];
            if (!e.el.removed && !e.paused) {
                ...
                delete e.initstatus,
                e.stop && gb.splice(d--, 1)) : e.status = (e.prev + (e.percent - e.prev) * (h / i)) / e.anim.top,
                !(0 > h))
                    if (i > h) {
                        var q = j(h / i);
                        for (var r in k)
                            if (k[z](r)) {
                                ...
                                case T:
                                    ...
                                    break;
                                case "colour":
                                    f = "rgb(" + [jb($(k[r].r + q * i * l[r].r)), jb($(k[r].g + q * i * l[r].g)), jb($(k[r].b + q * i * l[r].b))].join(",") + ")";
                                    break;
                                case "path":
                                    f = [];
    ...
    Ya.animateWith = function(a, b, d, e, f, g) {
        var h = this;
        if (h.removed)
            return g && g.call(h),
            h;
        ...
        for (var j = 0, k = gb.length; k > j; j++)
            if (gb[j].anim == b && gb[j].el == a) {
                gb[k - 1].start = gb[j].start;
                break
            }
        return h
    }
    ,
    Ya.onAnimation = function(a) {
    ...
    ,
    Ya.setTime = function(a, b) {
        return a && null != b && this.status(a, P(b, a.ms) / a.ms),
        this
    }
    ,
    Ya.status = function(a, b) {
        var c, d, e = [], f = 0;
        if (null != b)
            return s(a, this, -1, P(b, 1)),
            this;
        for (c = gb.length; c > f; f++)
            if (d = gb[f],
    ...
    Ya.pause = function(a) {
        for (var c = 0; c < gb.length; c++)
            gb[c].el.id != this.id || a && gb[c].anim != a || b("raphael.anim.pause." + this.id, this, gb[c].anim) !== !1 && (gb[c].paused = !0);
        return this
    }
    ,
    Ya.resume = function(a) {
        for (var c = 0; c < gb.length; c++)
            if (gb[c].el.id == this.id && (!a || gb[c].anim == a)) {
                var d = gb[c];
    ...
    Ya.stop = function(a) {
        for (var c = 0; c < gb.length; c++)
            gb[c].el.id != this.id || a && gb[c].anim != a || b("raphael.anim.stop." + this.id, this, gb[c].anim) !== !1 && gb.splice(c--, 1);
        return this
    }
    ,
    ...
    var kb = function(a) {
        ...
        a)
            for (var b = 0, c = a.length; c > b; b++)
                !a[b] || a[b].constructor != Ya.constructor && a[b].constructor != kb || (this[this.items.length] = this.items[this.items.length] = a[b],
                this.length++)
    }
      , lb = kb.prototype;
    lb.push = function() {
        for (var a, b, c = 0, d = arguments.length; d > c; c++)
            a = arguments[c],
            !a || a.constructor != Ya.constructor && a.constructor != kb || (b = this.items.length,
    ...
    function() {
        if (c.svg) {
            ...
            B.attr = function(b, d) {
                ...
                if (null == d && c.is(b, "string")) {
                    ...
                    for (var g = b.split(j), h = {}, i = 0, l = g.length; l > i; i++)
                        b = g[i],
                        b in this.attrs ? h[b] = this.attrs[b] : c.is(this.paper.customAttributes[b], "function") ? h[b] = this.paper.customAttributes[b].def : h[b] = c._availableAttrs[b];
                    return l - 1 ? h : h[g[0]]
                }
            ...
            B.toFront = function() {
                ...
                var b = this.paper;
                return b.top != this && c._tofront(this, b),
                this
            }
            ,
            B.toBack = function() {
            ...
            B.insertBefore = function(a) {
                ...
                var b = z(this.node)
                  , d = z(a.node || a[0].node);
                return d.parentNode.insertBefore(b, d),
            ...
            c.prototype.clear = function() {
                ...
                (this.desc = q("desc")).appendChild(c._g.doc.createTextNode("Created with Rapha�l " + c.version)),
