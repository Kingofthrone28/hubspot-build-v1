...
if ( !$('html').hasClass('hs-inline-edit') ) {
	...
	let animationInterval = 110;
	let animationOffet = -60;
	let fadeDistance = '100px';
	let slideDistance = '100px';
	let zoomInDistance = '100px';
	let zoomOutDistance = '150px';
	let easingSetting = 'cubic-bezier(0.5, 0, 0, 1)';
	let mobileSetting = true;
