/*
* g.raphael-radar 0.3 - Radar chart, based on Rapha�l.js
    ...
    function Radar(paper, cx, cy, r, values, opts) {
      ...
      angle = 360 / values.length;
        ...
        var circle = function (cx, cy, r, angle, value, max, title) {
            ...
            paper.circle(p.x, p.y, opts.pathCircleInnerRadius * 2).attr({ fill: opts.dotFill, stroke: "none", title: title + ": " + value });
        }
